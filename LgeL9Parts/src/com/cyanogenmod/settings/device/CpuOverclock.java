...
public class CpuOverclock implements OnPreferenceChangeListener {

    private static final String FILE = "/sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq";
    ...
    public static void restore(Context context) {
        ...
        Utils.writeValue(FILE, sharedPrefs.getString(DevicePerformanceActivity.KEY_CPU_OVERCLOCK, "1008000"));
    }
